...
public class PythonPlugin implements LanguagePlugin, Closeable {
	...
	private String parserPath= "RefDiff\\refdiff-python\\src\\main\\resources\\parser.py";// Insert the absolut path to the parser.py, ex C://......
	private String envpath = "python";//or insert the path to the environment 
